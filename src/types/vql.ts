...
export type VQL_Query_CRUD_Keys = VQL_Query_CRUD_Data extends infer U
...
/** VQL Query */
export type VQL_Query<T = any> = (VQL_Query_CRUD<T> | VQL_Query_Relation) &
	VQL_Var;
/** VQL Universal Query */
export type VQLUQ<T = any> =
	| VQL_Query<T>
	| string
	| ({
			query: string;
